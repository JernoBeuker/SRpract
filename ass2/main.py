...
from config import STARTING_PROMPT1, STARTING_PROMPT2, STARTING_TEXT, WHO_IS_WHAT, NATURAL_POS, GESTURES, EUREKA, CELEBRATE, TIME_PER_SYLLABLE, GESTURE_TIME
...
def play_taboo(session):
    ...
    while True:
        ...
        if word_array == None:  # could not get words from user
            ...
            # 30% chance of performing the iconic "eureka" gesture
